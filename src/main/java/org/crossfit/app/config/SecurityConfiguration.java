...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/bill/**").hasAnyAuthority(AuthoritiesConstants.COMPTABLE, AuthoritiesConstants.ADMIN)
            ...
            .antMatchers("/private/planning/**").hasAnyAuthority(AuthoritiesConstants.COACH,AuthoritiesConstants.MANAGER, AuthoritiesConstants.ADMIN)
